...
- Les URLs doivent être les liens directs vers les articles, pas les pages d'accueil des sites.
- Si des chiffres ou exemples ne sont pas disponibles dans les sources, ne les invente pas :
  indique "Données chiffrées non disponibles dans les sources consultées."
